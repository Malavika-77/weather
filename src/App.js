...
const App = () => {
  ...
  return (
    <div>
    <div className="min-h-screen w-screen flex items-center justify-center bg-gray-50" style={{ backgroundImage: `url(${require('./back.jpg')})` }}>
      <div className="max-w-md w-full">
        ...
        {weatherData && (
          <div className="mt-0 w-full "style={{ position:"absolute",left:"10px",top:"70px"}}>
